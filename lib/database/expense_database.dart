...
class ExpenseDatabase extends ChangeNotifier {
  ...
  Future<Map<String, double>> canculateMonthyTotals() async {
    await readExpenses();
  ...
  Future<double> calculateMonthyTotal() async {
    await readExpenses();
    int currentMonth = DateTime.now().month;
    int currentYear = DateTime.now().year;

    List<Expense> currentMonthExpenses = _allExpenses.where((element) {
